...
<div class="container">
    <div class="headers">
        <ul class="unorderedListHeaders">
            <li></li>
            <li onclick={sortByName} style="{colors[sortByNamePicker]}">
                Name/Movie
            </li>
            <li onclick={sortByTime} style="{colors[sortByTimePicker]}">
                Time
            </li>
            <li onclick={sortByDate} style="{colors[sortByDatePicker]}">
                Starts
            </li>
