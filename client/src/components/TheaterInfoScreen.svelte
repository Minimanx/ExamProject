...
<div class="container">
    <div class="infoContainer">
        ...
        {#if theater.passwordBool}
            <input type="password" maxlength="24" bind:value={password} onfocus={() => $playerMovement = false} onblur={() => $playerMovement = true} placeholder="Type password here...">
        {/if}
    </div>

    <button class="joinTheaterButton" onclick={joinTheater} disabled={joining}>{joining ? "Joining..." : "Join"}</button>
